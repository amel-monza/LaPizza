    ...
    <>
      ...
      <div className={styles.ChapterTwo}>
        ...
        <div className={styles.Rights}>
          <span className={styles.AllRights}>© 2021 All Rights Reserved | LaPizza.com</span>
          <span  className={styles.MadeBySpan}>
           <p>Made by Monza</p> 
               <a target="_blank" rel="noopener noreferrer" href="https://www.github.com/xpmprd" id="blank" className={styles.LinkToGit}>
                    <img src={git} alt="/" width="40px" height="40px" id="git"/>
                    </a>
                    </span>
        </div>
      </div>
